...
load_and_process_pseudobulk <- function() {
  if (!file.exists(here("00_data", "raw", "unprocessed", "scRNA_processing_files", "run4_pseudobulk.rds"))) {
    # Load Seurat object
    run4_combined_samples <- readRDS(here("/efs", "plasticell", "scRNA", "plasticell_scRNA",
    ...
    # Save processed data
    saveRDS(pseudo_counts, here("00_data", "raw", "unprocessed", "scRNA_processing_files", "run4_pseudobulk.rds"))
    saveRDS(pseudo_counts_vg, here("00_data", "raw", "unprocessed", "scRNA_processing_files", "run4_pseudobulk_vg.rds"))
    saveRDS(variable_genes, here("00_data", "raw", "unprocessed", "scRNA_processing_files", "run4_variable_genes.rds"))
    saveRDS(pseudo_counts_vg_long, here("00_data", "raw", "unprocessed", "scRNA_processing_files", "run4_pseudobulk_long.rds"))
  }else{
    pseudo_counts <<- readRDS(here("00_data", "raw", "unprocessed", "scRNA_processing_files", "run4_pseudobulk.rds"))
    pseudo_counts_vg <<- readRDS(here("00_data", "raw", "unprocessed", "scRNA_processing_files", "run4_pseudobulk_vg.rds"))
    variable_genes <<- readRDS(here("00_data", "raw", "unprocessed", "scRNA_processing_files", "run4_variable_genes.rds"))
    pseudo_counts_vg_long <<- readRDS(here("00_data", "raw", "unprocessed", "scRNA_processing_files", "run4_pseudobulk_long.rds"))
  }
}

# Function to generate NK proportion dataframe if not already saved
generate_nk_proportion <- function() {
  if (!file.exists(here("00_data", "raw", "unprocessed", "scRNA_processing_files", "run4_nk_proportion.rds"))) {
    ...
    saveRDS(proportion_NK, here("00_data", "raw", "unprocessed", "scRNA_processing_files", "run4_nk_proportion.rds"))
  } else {
    proportion_NK <<- readRDS(here("00_data", "raw", "unprocessed", "scRNA_processing_files", "run4_nk_proportion.rds"))
  }
}
